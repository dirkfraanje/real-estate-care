  ...
  methods: {
    dismissNotification(notification) {
      if (!(localStorage.getItem(notificationLocalWarningShown) === "true")) {
        this.$store.dispatch('showSnackbarFailed',["For this prototype the notification will not be permenantly removed. It will be shown again after the app is restarted.", 5500]);
        // (context, data = 'Failed') {
